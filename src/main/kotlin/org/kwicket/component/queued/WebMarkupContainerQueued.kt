 ...
 */
fun <T> MarkupContainer.webMarkupContainer(
    id: String,
    model: IModel<T>? = null,
    ...
    block: (IWebMarkupContainerConfig<T>.() -> Unit)? = null
): WebMarkupContainer = q(
...
fun MarkupContainer.webMarkupContainer(
    ...
    onConfig: (WebMarkupContainer.() -> Unit)? = null,
    postInit: (WebMarkupContainer.() -> Unit)? = null,
    block: (IWebMarkupContainerConfig<*>.() -> Unit)? = null
): WebMarkupContainer = q(
    id = id, block = block, factory = { cid, config -> config(cid) }, config =
    WebMarkupContainerConfig<Unit>(
        markupId = markupId,
        outputMarkupId = outputMarkupId,
        outputMarkupPlaceholderTag = outputMarkupPlaceholderTag,
        isVisible = visible,
