...
/**
 * Configuration for creating a [RadioGroup] component.
 *
 ...
 * @param isRequired whether the data in the radio group is required
 * @param validator validator to check whether the data in the radio group is valid
 * @param validators validators to check whether the data in the radio group is valid
