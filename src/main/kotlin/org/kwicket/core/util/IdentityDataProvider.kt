package org.kwicket.core.util

import org.apache.wicket.extensions.markup.html.repeater.data.table.filter.IFilterStateLocator
import org.apache.wicket.extensions.markup.html.repeater.util.SortParam
import org.apache.wicket.model.IModel
import org.kwicket.core.model.IdentityLoadableDetachableModel
...
open class IdentityDataProvider<T, I : Serializable, C, S, U>(
    ...
    count = { source.count(criteria.obj) },
    ...
    override fun getFilterState(): C = criteria.obj
}